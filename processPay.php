   ...
   $conn = mysqli_connect($servername,$username2,$password,$dbname);
       ...
       $result = $conn->query($sql);
         ...
         $row = $result->fetch_assoc();
           ...
           $sql2 = "INSERT IGNORE INTO orders (id,firstname, lastname, rowNumber, seat, typeof, price, email)
       VALUES ('$id','$fName','$lName','$rowS', '$seat','$type','$total','$email')";
